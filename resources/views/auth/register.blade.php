   ...
   <section class="login-content">
      <div class="row m-0 align-items-center bg-white vh-100">            
         <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            <img src="{{asset('images/auth/pertamina-home-2.jpg')}}" class="img-fluid gradient-main animated-scaleX" alt="images">
         </div>
         <div class="col-md-6">           
               ...
               <div class="col-md-10">
                  <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                     <div class="card-body">
                        ...
                        <p class="text-center">Buat akun {{env('APP_NAME')}} mu.</p>
                        ...
                        <form method="POST" action="{{route('register')}}" data-toggle="validator">
                           ...
                           <div class="row">
                              ...
                              <div class="d-flex justify-content-center">
                                 <div class="form-check mb-3">
                                    <label class="form-check-label" for="customCheck1">Saya setuju dengan ketentuan penggunaan</label>
                           ...
                           <p class="mt-3 text-center">
                             Sudah mempunyai akun? <a href="{{route('auth.signin')}}" class="text-underline">Sign In</a>
                           </p>
                        </form>
                     </div>
                  </div> 
