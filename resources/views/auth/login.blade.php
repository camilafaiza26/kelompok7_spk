   ...
   <section class="login-content">
      <div class="row m-0 align-items-center bg-white vh-100">
                     ...
                     <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" data-toggle="validator">
                           ...
                           <p class="mt-3 text-center">
                             Belum mempunyai akun? <a href="{{route('auth.signup')}}" class="text-underline">Klik disini untuk register.</a>
                           </p>
                        </form>
                     </div>
                  </div>
         ...
         <div class="col-md-6 d-md-block d-none bg-primary p-0 mt-n1 vh-100 overflow-hidden">
            <img src="{{asset('images/auth/pertamina-home.jpg')}}" class="img-fluid gradient-main animated-scaleX" alt="images">
         </div>
      </div>
   </section>
</x-guest-layout>
