                        ...
                        <tr>
                           ...
                           <td>
                              <div class="d-flex flex-nowrap">
                                 ...
                                 <button class="btn btn-sm btn-icon btn-warning" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"  data-bs-toggle="modal" data-bs-target="#edit{{$kriteria->id, $kriteria->nama}}" >
                                 ...
                                 <div class="modal fade" id="edit{{$kriteria->id, $kriteria->nama}}" tabindex="-1" aria-labelledby="editLabel" aria-hidden="true">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                 ...
                                 <form class="" action="{{ route('kriteria.destroy', $kriteria->id) }}" onsubmit="return confirm('Apakah anda yakin?');" method="POST">
                                    @csrf
                                    @method('DELETE')
