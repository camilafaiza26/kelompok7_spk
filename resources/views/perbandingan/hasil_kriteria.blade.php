           ...
           <div class="card">
              <div class="card-header d-flex justify-content-between">
                 <div class="header-title">
                    <h4 class="card-title">Hasil Perbandingan Kriteria</h4>
                 </div>
              </div>
...
<a  class="btn btn-primary" href="{{Route('perbandingan-kriteria.index')}}">
    Kembali
</a>
<?php
	}
...
?>
<a  class="btn btn-primary" href="{{Route('perbandingan-alternatif', 1)}}">
    Lanjut
</a>
<?php 
	}
