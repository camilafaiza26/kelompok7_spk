                     ...
                     <div class="card-body">
                        <div class="progress-widget">
                           ...
                           <div class="progress-detail">
                              ...
                              <h4 class="counter" style="visibility: visible;">{{$jmlKriteria}}</h4>
                           </div>
                        </div>
                     </div>
                  </li>
         ...
         <div class="row">
               ...
               <div class="card" data-aos="fade-up" data-aos-delay="800">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        <h4 class="card-title">Bensin Terbaik</h4>
                        <p class="mb-0">Hasil Perhitungan Bensin Terbaik</p>
                     </div>
                     <div class="d-flex align-items-center align-self-center">
                        <div class="d-flex align-items-center text-primary">
                           ...
                           <div class="ms-2">
                              <span class="text-secondary">Pertamax</span>
                           </div>
                        </div>
                        <div class="d-flex align-items-center ms-3 text-info">
                           ...
                           <div class="ms-2">
                              <span class="text-secondary">Pertamax Turbo</span>
                           </div>
                        </div>
                        <div class="d-flex align-items-center ms-3 text-info">
                           <svg xmlns="http://www.w3.org/2000/svg" width="12" viewBox="0 0 24 24" fill="currentColor">
                           ...
                           <div class="ms-2">
                              <span class="text-secondary">Pertalite</span>
                           </div>
                        </div>
                     </div>
                  </div>
            ...
            <div class="col-md-12 col-lg-12">
               <div class="card overflow-hidden" data-aos="fade-up" data-aos-delay="400">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        <h4 class="card-title mb-2">Hasil Perangkingan</h4>
                        <p class="mb-0">
         ...
         <div class="row">
            <div class="col-md-12 col-lg-12">
               <div class="card" data-aos="fade-up" data-aos-delay="400">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        <h4 class="card-title mb-2">Alternatif</h4>
                     </div>
                  </div>
                  <div class="card-body">
                     ...
                     <div class=" d-flex profile-media align-items-top mb-2">
                        ...
                        <div class="ms-4">
                           <p class=" mb-1"> {{$alternatif->nama}}</p>
                        </div>
                     </div>
                     @endforeach
                     </div>
            ...
            <div class="col-md-12 col-lg-12">
               <div class="card" data-aos="fade-up" data-aos-delay="400">
                  <div class="card-header d-flex justify-content-between flex-wrap">
                     <div class="header-title">
                        <h4 class="card-title mb-2">Kriteria</h4>
                     </div>
                  </div>
                  <div class="card-body">
